...
description: >-
  Step-by-step tutorial for creating Domains and assigning data assets to them
  in DataHub via the GraphQL API and Python SDK.
sidebar_label: Domains API Tutorial
