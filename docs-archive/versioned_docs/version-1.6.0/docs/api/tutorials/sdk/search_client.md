...
description: >-
  Use DataHub's Python SDK search client to filter, query, and discover
  datasets, dashboards, and other metadata entities programmatically.
sidebar_label: Search Client SDK Tutorial
