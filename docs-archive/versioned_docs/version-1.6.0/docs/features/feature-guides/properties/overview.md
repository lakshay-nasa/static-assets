...
description: >-
  Add custom, validated metadata fields to any DataHub entity using Structured
  Properties to support governance and discovery use cases.
sidebar_label: Custom Properties Overview
