...
description: >-
  Pre-built ingestion venvs under /opt/datahub/venvs, extending datahub-actions
  or datahub-executor images at build time.
sidebar_label: Bundled ingestion virtual environments
slug: /docker/bundled-ingestion-venvs
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/docker/bundled-ingestion-venvs.md
---
