...
description: >-
  Build a Business Glossary in DataHub to define a shared vocabulary of business
  terms and link them to physical data assets.
sidebar_label: Business Glossary Guide
