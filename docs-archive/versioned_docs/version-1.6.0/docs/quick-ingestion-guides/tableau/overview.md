...
description: >-
  Quick start guide for ingesting Tableau workbooks, dashboards, sheets, and
  lineage into DataHub via the UI ingestion workflow.
sidebar_label: Tableau Overview
