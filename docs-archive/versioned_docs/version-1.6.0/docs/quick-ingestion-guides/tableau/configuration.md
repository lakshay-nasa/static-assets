...
description: >-
  Configure DataHub UI ingestion to connect to Tableau using the dedicated
  DataHub user and Site Administrator Explorer access.
sidebar_label: Tableau Configuration
