---
title: WAR Extraction to tmpfs Optimization
slug: /advanced/jar-extraction-tmpfs-optimization
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/advanced/jar-extraction-tmpfs-optimization.md
---
