---
title: GraphQL Shape Logging Runbook
slug: /advanced/graphql-shape-logging-runbook
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/advanced/graphql-shape-logging-runbook.md
---
