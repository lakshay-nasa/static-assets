...
slug: /dev-guides/agent-context/databricks-genie-code
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/dev-guides/agent-context/databricks-genie-code.md
---
