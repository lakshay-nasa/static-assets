...
sidebar_position: 93
description: >-
  Teradata is an enterprise data warehouse platform for storing, managing, and
  analyzing large volumes of structured data at scale.
title: Teradata
...
```javascript
{
  ...
  "properties": {
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2026-08-07T15:10:44.667370Z",
