...
sidebar_position: 5
description: >-
  Athena is a serverless interactive query service that enables users to analyze
...
```javascript
{
  ...
  "properties": {
    ...
    "iceberg_platform_instance": {
      ...
      "default": null,
      "description": "Platform instance of the upstream Iceberg datasets that Athena lineage points to. Set this if your Iceberg connector is configured with a non-default platform_instance; leave unset otherwise.",
