...
sidebar_position: 21
description: >-
  dbt is a data transformation tool that enables analysts and engineers to
  transform data in their warehouses through a modular, SQL-based approach.
title: dbt
...
source:
  ...
  config:
    ...
    run_results_paths:
      ...
      # Glob patterns are supported for both S3 and local paths, e.g.:
