...
sidebar_position: 88
description: >-
  DataHub utility for ingesting SQL query metadata and lineage from query log
  files, generating column-level lineage between datasets.
title: SQL Queries
...
```javascript
{
  ...
  "properties": {
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2026-08-07T15:10:44.194804Z",
