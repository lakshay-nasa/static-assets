...
sidebar_position: 25
description: >-
  Dremio is a data lake engine that provides fast, direct access to data lake
  storage with enterprise-grade security and governance.
title: Dremio
...
```javascript
{
  ...
  "properties": {
    ...
    "path_to_certificates": {
      "default": "/private/tmp/datahub-v1.6.0.1rc2/metadata-ingestion/venv/lib/python3.11/site-packages/certifi/cacert.pem",
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2026-08-07T15:10:21.066267Z",
