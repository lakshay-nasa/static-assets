...
sidebar_position: 37
description: >-
  Google Cloud's intelligent data fabric for unified data management,
  governance, and analytics across data lakes and warehouses.
title: Google Cloud Knowledge Catalog (Dataplex)
