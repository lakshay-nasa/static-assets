...
description: >-
  The DataHub Actions Framework lets you respond to real-time metadata changes
  and integrate DataHub into event-driven architectures.
sidebar_label: DataHub Actions Framework
slug: /actions
