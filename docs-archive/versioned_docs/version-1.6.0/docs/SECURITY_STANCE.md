---
description: >-
  DataHub's commitment to security, including vulnerability handling, dependency
  scanning, and community-driven disclosures.
title: DataHub's Commitment to Security
slug: /security_stance
custom_edit_url: 'https://github.com/datahub-project/datahub/blob/master/docs/SECURITY_STANCE.md'
---
