---
title: Snowflake Metadata Sync Automation
slug: /automations/snowflake-metadata-sync
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/snowflake-metadata-sync.md
---
