---
title: Knowledge Catalog Metadata Sync Automation
slug: /automations/knowledge-catalog-metadata-sync
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/knowledge-catalog-metadata-sync.md
---
