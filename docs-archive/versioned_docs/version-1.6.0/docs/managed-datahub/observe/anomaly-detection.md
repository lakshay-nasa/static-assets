---
description: >-
  This page provides an overview of Anomaly Detection for DataHub Cloud
  assertions
title: Anomaly Detection ⚡
slug: /managed-datahub/observe/anomaly-detection
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/anomaly-detection.md
---
