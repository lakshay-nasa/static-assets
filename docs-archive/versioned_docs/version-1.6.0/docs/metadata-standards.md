---
description: >-
  How DataHub serves as a de-facto metadata standard for the modern data and AI
  stack across datasets, dashboards, and ML models.
title: Metadata Standards
slug: /metadata-standards
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/metadata-standards.md
---
