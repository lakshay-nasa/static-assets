...
<td>
severity<br />
<a href="/docs/graphql/enums#assertionresultseverity"><code>AssertionResultSeverity</code></a>
</td>
<td>
<p>The severity of a failure result. Only meaningful when type is FAILURE.
Indicates how far the observed value deviated from the expected bounds.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>The URN of the actor who made this change</p>
</td>
</tr>
<tr>
<td>
...
<td>
<blockquote>Deprecated: Use tags field instead</blockquote>

<p>Deprecated, use tags field instead.
The structured tags associated with the Document.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
vertexProviderConfig<br />
<a href="/docs/graphql/objects#vertexproviderconfig"><code>VertexProviderConfig</code></a>
</td>
<td>
<p>Google Vertex AI-specific configuration (only populated when provider is &quot;vertex_ai&quot;)</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
showTestsInHealthIcon<br />
<a href="/docs/graphql/scalars#boolean"><code>Boolean!</code></a>
</td>
<td>
<p>If enabled, shows tests in the health icon on entity pages.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>The lifecycle status of the Glossary Term (removed flag and lifecycle stage).</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Full URN of the lifecycle stage type entity.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Display name (e.g. &quot;Draft&quot;, &quot;In Review&quot;, &quot;Deprecated&quot;).</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Optional description of what this stage represents.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Entity type names this stage applies to (e.g. [&quot;glossaryTerm&quot;, &quot;document&quot;]).
Null / absent means the stage applies to all entity types.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>When true, entities in this stage are excluded from default search results.</p>
</td>
</tr>
<tr>
<td>
allowedPreviousStages<br />
<a href="/docs/graphql/scalars#string"><code>[String!]</code></a>
</td>
<td>
<p>Allowed previous stage URNs that may transition into this stage.
Null means any prior stage is allowed (no enforcement).
Empty list means the stage is unreachable.
Use &quot;`urn:li:lifecycleStageType:`<strong>NONE</strong>&quot; as the sentinel for the default active state.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
manageGlobalSettings<br />
<a href="/docs/graphql/scalars#boolean"><code>Boolean!</code></a>
</td>
<td>
<p>Whether the user should be able to view and change platform-level settings (e.g. integrations).</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>The default DataHub View applied when this service account performs searches
via the MCP server. Null when no default is configured.</p>
</td>
</tr>
<tr>
<td>
...
<td>
lifecycleStage<br />
<a href="/docs/graphql/objects#lifecyclestagetype"><code>LifecycleStageType</code></a>
</td>
<td>
<p>The resolved lifecycle stage of this entity.
...
without an additional client round-trip.</p>
</td>
</tr>
<tr>
<td>
lifecycleLastUpdated<br />
<a href="/docs/graphql/objects#auditstamp"><code>AuditStamp</code></a>
</td>
<td>
<p>Attribution for the lifecycle stage transition — who moved the entity
into its current stage and when.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>GCP project ID where Vertex AI is enabled</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>GCP region for the Vertex AI endpoint (e.g., &quot;us-east1&quot;, &quot;us-central1&quot;)</p>
</td>
</tr>
</tbody>
</table>
