...
Ignored for SUCCESS and ERROR result types.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
shouldAddCreatorAsOwner<br />
<a href="/docs/graphql/scalars#boolean"><code>Boolean</code></a>
</td>
<td>
<p>Whether to add the creator as an owner of the application. Defaults to true if not specified.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
relatedEntityTypes<br />
<a href="/docs/graphql/scalars#string"><code>[String!]</code></a>
</td>
<td>
<p>Optional filter restricting the related entities to the given entity-registry
...
fetching a role&#39;s policies passes [&quot;dataHubPolicy&quot;] to exclude the rest.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
includeHiddenLifecycleStages<br />
<a href="/docs/graphql/scalars#boolean"><code>Boolean</code></a>
</td>
<td>
<p>When true, entities explicitly part of hidden lifecycle stages (e.g. DRAFT, IN_REVIEW) are included
in search results.</p>
</td>
</tr>
<tr>
...
## UpdateServiceAccountDefaultViewInput
...
<td>
<p>The URN of the service account to update.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>The URN of the DataHub View to set as the default.
If null, the current default view will be removed.</p>
</td>
</tr>
</tbody>
</table>
