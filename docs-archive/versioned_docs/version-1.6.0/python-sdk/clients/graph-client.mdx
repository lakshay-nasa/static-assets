...
Bases: [`DataHubRestEmitter`](rest-emitter.mdx#datahub.emitter.rest_emitter.DataHubRestEmitter), `OpenApiAPI`, `EntityVersioningAPI`
...
#### report_assertion_result(urn, timestamp_millis, type, properties=None, external_url=None, error_type=None, error_message=None, severity=None)
